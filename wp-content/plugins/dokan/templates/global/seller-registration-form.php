  ...
  <?php  if ( $the_query->have_posts() ) {  ?>
    <div class="pack_content_wrapper">
      <?php while ( $the_query->have_posts() ) { $the_query->the_post(); ?>
        <div class="product_pack_item" id="<?php echo the_title(); ?>">
            ...
            <div class="buy_pack_button">
              <a href="#" class="buy_product_pack">Seu Plano</a>
            </div>
...
<script type="text/javascript">
  $('#Gratuito').click(function() {
    ...
    $(this).addClass('chek');
    $('#Associada').removeClass('chek1');
    $('#Premium').removeClass('chek2');
  });

  $('#Associada').click(function() {
